...
total_num = min(len(image_clear), number)
...
print("[cloudy dir]\ttest: %d, val:%d, train:%d" % (len(os.listdir(test_path_cloudy)), len(
    os.listdir(val_path_cloudy)), len(os.listdir(train_path_cloudy))))
print("[clear dir]\ttest: %d, val:%d, train:%d" % (len(os.listdir(test_path_clear)), len(
    os.listdir(val_path_clear)), len(os.listdir(train_path_clear))))
